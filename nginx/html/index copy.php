...
<html>
    ...
    <body>
        ...
        <?php
        $connection = new PDO('mysql:host=mysql;dbname=co2_monitor;charset=utf8', 'root', 'root');
        $query      = $connection->query("SELECT TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'co2_monitor'");
